...
class Editor:
    ...
    def __init__(self, view, status_bar=None):
        ...
        self.rmDeviceCallback = None
        self.addDeviceCallback = None
    ...
    def check_usb(self):
        ...
        for device in to_remove:
            ...
            if self.rmDeviceCallback is not None:
                self.rmDeviceCallback(device)
        ...
        for device in devices:
            if device not in self.connected_devices:
                ...
                if self.addDeviceCallback is not None:
